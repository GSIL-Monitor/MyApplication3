package com.cxy.yuwen.mail;

import android.support.annotation.NonNull;

import com.cxy.yuwen.tool.SimpleMailSender;
...
public class EmailUtil {
    ...
    private static final String FROM_PSW = "sgnyyqapdrzahddc";//发送方邮箱授权码，并非密码   //tiuwrzvfkdgbegbd
...
////    private static final String TO_ADD = "2584770373@qq.com";
    ...
    private static MailSenderInfo creatMail(String content) {
        ...
        mailInfo.setSubject("语文助手反馈"); // 邮件主题
