...
//      });
     ...
     * @return
     */
    public boolean sendFileMail(MailSenderInfo info, File file){
     ...
     * @return
     */
    private Message createAttachmentMail(final MailSenderInfo info, File file) {
        //创建邮件
